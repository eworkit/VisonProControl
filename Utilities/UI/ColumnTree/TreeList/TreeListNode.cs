...
namespace CommonTools
{
	public class Node
	{
        ...
        {
            get { return m_headerImageId; }
            set { m_headerImageId = value; }
        }
    ...
    public class CheckNode : Node
    {
        ...
        public event EventHandler CheckCliced;
        bool isChecked=true;
        ...
        {
            if (CheckCliced != null)
                CheckCliced(this, EventArgs.Empty);
        }
        public CheckNode() : base() {   }
        public CheckNode(string text) : base(text)
        {  
        }
    }
