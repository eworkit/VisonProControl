...
namespace Utilities.UI.MyGraphics
{
    ...
    public static class GraphicsPathHelper
    {
        ...
        public static GraphicsPath CreateOptionFlagPath(Rectangle rect)
        {
            GraphicsPath path = new GraphicsPath();
            int x = rect.X + (rect.Width - 9) / 2;
            int y = rect.Y + (rect.Height - 7) / 2;
            Point p1 = new Point(x + 0, y + 0);
            Point p2 = new Point(x + 8, y + 0);
            Point p3 = new Point(x + 0, y + 2);
            Point p4 = new Point(x + 8, y + 2);
            Point p5 = new Point(x + 0, y + 4);
            Point p6 = new Point(x + 8, y + 4);
            Point p7 = new Point(x + 0, y + 6);
            Point p8 = new Point(x + 8, y + 6);
            path.AddLine(p1, p2);
            path.CloseFigure();
            path.AddLine(p3, p4);
            path.CloseFigure();
        ...
        public static GraphicsPath CreateMinimizeFlagPath(Rectangle rect)
        {
            ...
            Point p2 = new Point(x + 8, y + 5);
            Point p3 = new Point(x + 0, y + 6);
            Point p4 = new Point(x + 8, y + 6);
        ...
        public static GraphicsPath CreateMaximizeFlagPath(Rectangle rect)
        {
            ...
            path.AddRectangle(new Rectangle(new Point(x, y), new Size(8, 8)));
            path.CloseFigure();
            path.AddLine(p1, p2);
            return path;
        }
...
//             p1 = new Point(x+3, y + 0);
//             p2 = new Point(x + 9, y + 0);
//             p3 = new Point(x + 9, y + 1);
//             p4 = new Point(x + 9, y + 5);
//             p5 = new Point(x+3, y + 5);
//             p6 = new Point(x+3, y + 1);
// 
//             p7 = new Point(x + 10, y + 1);
//             p8 = new Point(x + 12, y + 1);
//             p9 = new Point(x + 12, y + 1);
//             p10 = new Point(x + 6, y - 2);
//             p11 = new Point(x + 6, y - 1);
//             p12 = new Point(x + 6, y-3);
//             p13 = new Point(x + 12, y-3);
//             path.CloseFigure();
//             path.AddLines(new Point[] { p1, p2, p4, p5, p6, p3, p2, p1 });
//             path.CloseFigure();
// 
