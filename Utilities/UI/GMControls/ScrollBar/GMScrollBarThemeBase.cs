...
namespace Utilities.UI
{
    public class GMScrollBarThemeBase : IDisposable
    {
        ...
        public GMButtonThemeBase SideButtonTheme { get; set; }
        public GMButtonThemeBase MdlButtonTheme { get; set; }
        ...
        private void SetDefaultValue()
        {
            ...
            SideButtonForePathGetter = new ButtonForePathGetter(
                Utilities.UI.MyGraphics.GraphicsPathHelper.Create7x4In7x7DownTriangleFlag);
        ...
        private GMButtonThemeBase GetSideButtonTheme()
        {
            GMButtonThemeBase theme = new GMButtonThemeBase();
            theme.ColorTable = SideBtnColor();
            theme.RoundedStyle = MyGraphics.RoundStyle.All;
            theme.RoundedRadius = 0;
            return theme;
        }

        private GMButtonThemeBase GetMdlButtonTheme()
        {
            GMButtonThemeBase theme = new GMButtonThemeBase();
