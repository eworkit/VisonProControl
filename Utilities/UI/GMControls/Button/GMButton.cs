...
{
    public class GMButton : Button, IGMControl
    {
        #region 构造函数及初始化
        ...
        {
            get { return GMControlType.Button; }
        }
        ...
        [Browsable(false)]
        public GMButtonThemeBase XTheme
        {
            get
            {
        ...
        public void SetNewTheme(GMButtonThemeBase xtheme)
        {
