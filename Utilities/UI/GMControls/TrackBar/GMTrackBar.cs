...
namespace Utilities.UI
{
    ...
    public class GMTrackBar : GMBarControlBase, IGMControl
    {
        ...
        {
            thumbButton.SetNewTheme(ThumbButtonTheme);
        ...
        protected virtual Color MainLineBorderColor1
        {
            get
            {
                if (_xtheme == null)
                    ...
                    return _xtheme.MainLineBorderColor1;
            }
        }

        protected virtual Color MainLineBorderColor2
        {
            get
            {
                if (_xtheme == null)
                    ...
                    return _xtheme.MainLineBorderColor2;
            }
        }
        ...
        protected virtual GMButtonThemeBase ThumbButtonTheme
        {
            get
            {
                if (_xtheme == null)
                    return DefaultThumbTheme();
                else
                    return _xtheme.ThumbButtonTheme;
            }
        }
        ...
        protected virtual GMButtonThemeBase DefaultThumbTheme()
        {
            GMButtonThemeBase theme = new GMButtonThemeBase();
            theme.RoundedRadius = 0;
            theme.RoundedStyle = RoundStyle.None;
            theme.ColorTable = DefaultThumbColor();
            return theme;
        }
        ...
        ///// <summary>
        ///// 该变量指示是否在可移动方向上，控件长度太小，无法容纳下Button，
        ///// 控件也就无法工作
        ///// </summary>
        //bool isLengthTooSmall;
        ...
        private int ButtonCurrentPositionDot
        {
            ...
            set
            {
                if (_buttonCurrentPositionDot != value)
                {
                    if (_barOrientation == Orientation.Horizontal)
                    {
                        if (value < ButtonBeginPositionDot)
                            _buttonCurrentPositionDot = ButtonBeginPositionDot;
                        else if (value > ButtonMaxPositionDot)
                            _buttonCurrentPositionDot = ButtonMaxPositionDot;
                        else
        ...
        {
            int begin = ButtonBeginPositionDot;
            int max = ButtonMaxPositionDot;
        ...
        private int GetDotFromValue(int value)
        {
            ...
            if (_barOrientation == Orientation.Horizontal)
                targetPos += ButtonBeginPositionDot;
            else
            {
                targetPos += ButtonMaxPositionDot;
                targetPos = (ButtonMaxPositionDot + ButtonBeginPositionDot) - targetPos;
            }
            return targetPos;
        }
        ...
        private void RenderFocusRect(Graphics g)
        {
            ...
            {
                BasicBlockPainter.RenderFocusRect(g, ClientRectangle, 1);
            }
        }
        ...
        private void RenderMainLine(Graphics g)
        {
            ...
            if (!e.Cancel)
            {
                RenderMainLine(g, MainLineRange1Rect, MainLineRange1BackColor, MainLineBorderColor1);
                RenderMainLine(g, MainLineRange2Rect, MainLineRange2BackColor, MainLineBorderColor2);
            }
            e.Dispose();
        }

        private void RenderMainLine(Graphics g, Rectangle rect, Color backColor, Color borderColor)
        {
        ...
        {
            GMTrackBarPaintEventArgs e = new GMTrackBarPaintEventArgs(g, ButtonRect);
            e.BtnState = thumbButton.State;
            OnBeforePaintButton(e);

            if (!e.Cancel)
                thumbButton.PaintControl(g);
            e.Dispose();
        }
        ...
        private int ButtonBeginPositionDot
        {
            get
            {
                if (_barOrientation == Orientation.Horizontal)
        ...
        private int ButtonMaxPositionDot
        {
            get
            {
                if (_barOrientation == Orientation.Horizontal)
        ...
        private int MainLineBegionDot
        {
            get
            {
                return ButtonBeginPositionDot + ButtonLength1 / 2;
            }
        }
        ...
        private int MainLineEndDot
        {
            get
            {
                return ButtonMaxPositionDot + ButtonLength1 / 2;
            }
        }
