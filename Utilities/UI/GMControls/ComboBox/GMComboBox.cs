...
{
    public class GMComboBox : GMBarControlBase, IGMControl
    {
        ...
        {
            TabStop = true;
            Items.CollectionChange += Items_CollectionChange;
        }

        void Items_CollectionChange(GMCollectionChangeArgs e)
        {
            dropDownFirstShow = true;
        }
        ...
        {
            get { return GMControlType.ComboBox; }
        }
        ...
        private GMToolStripDropDown _innerDropDown;
        private ToolStripControlHost _innerControlHost;
        private GMListBox _innerListBox;
        ...
        private GMListBox InnerListBox
        {
            get
            {
                if (_innerListBox == null)
                {
                    _innerListBox = new GMListBox();
        ...
        private GMToolStripDropDown InnerDropDown
        {
            get
            {
                if (_innerDropDown == null)
                {
                    _innerDropDown = new GMToolStripDropDown();
        ...
        GMComboBoxThemeBase _xtheme;
        bool _editable = true;
        ComboBoxStyle _DropDownStyle = ComboBoxStyle.DropDownList;
        ...
        [Browsable(false),EditorBrowsable(EditorBrowsableState.Never)]
        public GMComboBoxThemeBase XTheme
        {
            get
            {
                if (_xtheme == null)
                {
                    _xtheme = new GMComboBoxThemeBase();
                    DoWhenThemeChanged();
                }
                return _xtheme;
            }
        ...
        public ComboBoxStyle DropDownStyle
        {
            ...
            set
            {
                if (_DropDownStyle != value) {
                    ...
                    InnerTextBox.Visible = value == ComboBoxStyle.DropDown;
                    InnerRightButton.Visible = value != ComboBoxStyle.Simple;
                    base.Invalidate();
                }
            }
        }
        ...
        public void SetNewTheme(GMComboBoxThemeBase xtheme)
        {
            if (xtheme == null)
