...
{
    public class GMComboBoxThemeBase
    {
        ...
        public GMButtonThemeBase RightButtonTheme { get; set; }
        public GMListBoxThemeBase ListBoxTheme { get; set; }
        ...
        public GMComboBoxThemeBase()
        {
            ...
            ListBoxTheme = new GMListBoxThemeBase();
        ...
        private class ThemeButtonDefaultComboBox : GMButtonThemeBase
        {
