    ...
    public class GMProgressBar : GMBarControlBase, IGMControl
    {
        ...
        {            
            ...
            if (DrawBackColorGlass)
                GlassPainter.RenderRectangleGlass(g, ClientRectangle, BorderRadius, RoundStyle.All,
                    GlassPosition.Bottom, 270f, 0.5f, Color.White, 100, 20);
            ...
            if (rectCover.Width > 0)
            {
                ...
                if (DrawCoveredColorGlass)
                    GlassPainter.RenderRectangleGlass(g, rectCover, BorderRadius, RoundStyle.All,
                        GlassPosition.Top, 90.001f);
            }
