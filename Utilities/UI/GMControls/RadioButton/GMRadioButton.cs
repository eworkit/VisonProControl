...
{
    public class GMRadioButton : RadioButton, IGMControl
    {
        #region 构造函数及初始化

        public GMRadioButton()
        {
        ...
        {
            get { return GMControlType.RadioButton; }
        }
        ...
        public CheckMarkAlignment RadioMarkAlign
        {
            get
            {
        ...
        public void SetNewTheme(GMRadioButtonThemeBase xtheme)
        {
            if (xtheme == null)
        ...
        private GMRadioButtonThemeBase _xtheme;
        private GMButtonState state;

        private GMRadioButtonThemeBase XTheme
        {
            get
            {
                if (_xtheme == null)
                    _xtheme = new GMRadioButtonThemeBase();
                return _xtheme;
            }
        }
        ...
        private Size BestFittedSize
        {
            get
            {
                ...
                int w = XTheme.InnerPaddingWidth * 2 + XTheme.RadioMarkWidth +
                    XTheme.SpaceBetweenMarkAndText + textSize.Width;
                int h = XTheme.InnerPaddingWidth * 2 + Math.Max(XTheme.RadioMarkWidth, textSize.Height);
                return new Size(w, h);
            }
        }
        ...
        private void PaintRButton(Graphics g)
        {
            RadioButtonPainter.RenderRadioButton(
                g,
                ClientRectangle,
                XTheme,
                base.Enabled,
