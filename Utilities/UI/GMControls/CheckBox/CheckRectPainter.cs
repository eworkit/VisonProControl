...
namespace Utilities.UI
{
    ...
    {
        public static void RenderCheckRect(Graphics g, Rectangle rect, GMCheckBoxThemeBase xtheme,
            bool enable, CheckState checkState, GMButtonState state)
        {
            ...
            using (NewSmoothModeGraphics ng = new NewSmoothModeGraphics(g, SmoothingMode.HighSpeed))
            {
                ...
                using (Pen p = new Pen(rectColor))
                {
                    ...
                    // high light
                    if (xtheme.HighLightCheckRect && state == GMButtonState.Hover && enable)
                    {
