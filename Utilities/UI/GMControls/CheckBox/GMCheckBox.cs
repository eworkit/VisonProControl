...
{
    public class GMCheckBox : CheckBox, IGMControl
    {
        #region 构造函数及初始化
        ...
        {
            get { return GMControlType.CheckBox; }
        }
        ...
        public void SetNewTheme(GMCheckBoxThemeBase xtheme)
        {
            if (xtheme == null)
        ...
        private GMCheckBoxThemeBase _xtheme;
        private GMButtonState state;

        private GMCheckBoxThemeBase XTheme
        {
            get
            {
                if (_xtheme == null)
                    _xtheme = new GMCheckBoxThemeBase();
                return _xtheme;
            }
        }
