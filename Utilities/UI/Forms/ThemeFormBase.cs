...
namespace Utilities.UI
{
    ...
    public class ThemeFormBase
    {
        ...
        public int? IconTopMargin { get; set; }
        ...
        public Size OptionBoxSize { get; set; }
      ...
      //  public bool CaptionTextCenter { get; set; }
        ...
        /// 标题栏文字字体
        /// </summary>
        public Font CaptionTextFont { get; set; }
        ...
        ///  窗体Option按钮的颜色集合
        /// </summary>
        public ButtonColorTable OptionBoxColor { get; set; }
        ...
        public Image OptionBoxBackImageNormal { get; set; }
        public Image OptionBoxBackImageHover { get; set; }
        public Image OptionBoxBackImagePressed { get; set; }
        ...
        public ThemeFormBase()
        {
            ...
            CaptionTextFont = SystemFonts.CaptionFont;
       ...
       //     CaptionTextCenter = false;
            ...
            OptionBoxColor = MinBoxColor;// ButtonColorTable.GetDevWhiteThemeOptoinBtnColor();
            #region mdi support
