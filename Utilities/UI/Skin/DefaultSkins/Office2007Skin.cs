// This file is part of CoderLine IteUI.
//
// CoderLine IteUI is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// CoderLine IteUI is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with CoderLine IteUI.  If not, see <http://www.gnu.org/licenses/>.
//
...
using IteUI.Painting;
using IteUtils.Win32;
    ...
    public class Office2007Skin : SkinBase
    {
        ...
        protected virtual void LoadResourceManager()
        {
            switch (OfficeStyle)
            {
                ...
                case Office2007Style.ObsidianBlack:
                    ...
                    break;
                case Office2007Style.Itech:
                    _currentManager = DefaultSkins.ItechSkin.ResourceManager;
                    break;
            }
        }
        ...
        public override bool OnNcPaint(Form form, SkinningFormPaintData paintData)
        {
            ...
            if (paintData.HasMenu && form.Icon != null)
            {
               ...
               // iconBounds.Size = new Size(32, 18);
