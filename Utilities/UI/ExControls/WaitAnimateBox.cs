...
{
    public class WaitAnimateBox : Control
    {
        ...
        private float _InnerCircleRadius = 5;
        ...
        private PointF GetPointF(PointF centerPointF, float r, double angle)
        {
