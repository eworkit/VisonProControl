...
namespace Utilities.UI
{
    public class MessageBoxIndirect
    {
        ...
        public DialogResult Show()
        {
            ...
            try
            {
                ...
                // Instance = FindWindowEx(parms.hwndOwner, parms.hInstance, "", parms.lpszCaption);
                SetWindowPos(Instance, -1, 0, 0, 0, 0, 1 | 2);  // 置顶显示
            }
            finally
            {
                if (hHook > 0)
    ...
    public class MessageBoxEx
    {
       /// Displays a message box with specified text.
        ...
        {
          	MessageBoxIndirect mb = new MessageBoxIndirect(text);
            return mb.Show();
        }
        ...
        {
           	MessageBoxIndirect mb = new MessageBoxIndirect(owner , text );
            return mb.Show();
        }
        ...
        {
           	MessageBoxIndirect mb = new MessageBoxIndirect( text,caption );
            return mb.Show();
        }
        ...
        {
          	MessageBoxIndirect mb = new MessageBoxIndirect( owner,text,caption  );
            return mb.Show();
        }
        ...
        {
          	MessageBoxIndirect mb = new MessageBoxIndirect( text,caption,buttons );
            return mb.Show();
        }
        ...
        {
          	MessageBoxIndirect mb = new MessageBoxIndirect(owner,  text,caption,buttons  );
            return mb.Show();
        }
        ...
        {
            MessageBoxIndirect mb = new MessageBoxIndirect(text, caption, buttons,icon);
            return mb.Show();
        }
        ...
        {
            MessageBoxIndirect mb = new MessageBoxIndirect(owner, text, caption, buttons, icon);
            return mb.Show();
        }
        ...
        {
            MessageBoxIndirect mb = new MessageBoxIndirect(text, caption, buttons, icon,defaultButton);
            return mb.Show();
        }
