...
namespace Utilities.Threadx
{
    ...
    public class TList<T> : IList<T>
    {
        ...
        /// </summary>
        private readonly System.Threading.ReaderWriterLockSlim LockList = new System.Threading.ReaderWriterLockSlim();
        ...
        {
            get { return System.Threading.Thread.VolatileRead(ref m_Disposed) == 1; }
            set { System.Threading.Thread.VolatileWrite(ref m_Disposed, value ? 1 : 0); }
        }
