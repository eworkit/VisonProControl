...
namespace VisionControl
{
  ...
  public class FormAbout : System.Windows.Forms.Form
  {
    ...
    private VisionUC mVisionControl;

    public FormAbout(string fname, VisionUC ctl)
    {
      //
    ...
    private void FormAbout_Load(object sender, System.EventArgs e)
    {
      ...
      // general info
      this.textBox_AppInfo.Text = ResourceUtility.FormatString("RtAppGeneratedInfo", VisionUC.GenerationDateTime.ToString("r"),
        VisionUC.GeneratedByVersion);
